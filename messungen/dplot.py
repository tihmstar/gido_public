...
numberOfTraces = int(420e6)

plt.axis([0,numberOfTraces,-0.0003,0.0003])
plt.xticks(range(0,int(numberOfTraces),int(50e6)), fontsize=fontsize)
...
for i in range(0x100):
    if i == lmaxkey:
        continue
    plt.plot(xvals[i], yvals[i], color='lightgrey',linewidth=linewidth)
plt.plot(xvals[lmaxkey], yvals[lmaxkey], color='k',linewidth=linewidth)
