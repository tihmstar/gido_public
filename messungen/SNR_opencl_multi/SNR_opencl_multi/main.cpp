...
int doSNR(const char *indir, const char *outdir, long maxTraces, long minAllocSize){
    printf("start\n");
    ...
    cl_uint point_per_trace = 0;
    {
        ...
        Traces tr(toNormalizeList.at(0).c_str(),minAllocSize);
    ...
    powermodels.push_back({"traceSelector_DEC_INPUT", 0x100});
    powermodels.push_back({"traceSelector_DEC_INPUT_HW", 9});
    powermodels.push_back({"traceSelector_DEC_INPUT_HW4", 33});
    powermodels.push_back({"traceSelector_DEC_INPUT_KEY_HW", 9});
    powermodels.push_back({"traceSelector_SBOX", 0x100});
    powermodels.push_back({"traceSelector_SBOX_HW", 9});
    powermodels.push_back({"traceSelector_ZEROVALUE", 2});
    powermodels.push_back({"traceSelector_DEC_OUTPUT", 0x100});
    powermodels.push_back({"traceSelector_DEC_OUTPUT_HW", 9});
    powermodels.push_back({"traceSelector_DEC_OUTPUT_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET1_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET2_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET3_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0T1_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0T1T2_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0T1T2T3_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0P0_HW4", 33});
    powermodels.push_back({"traceSelector_TTABLET0P0K0_HW4", 33});
    powermodels.push_back({"traceSelector_P0K0_HW4", 33});
    powermodels.push_back({"traceSelector_ROUND_HW", 9});
    powermodels.push_back({"traceSelector_ROUND_HW4", 33});
    powermodels.push_back({"traceSelector_ROUND_VALUE", 0x100});
    powermodels.push_back({"traceSelector_ROUND_SBOX", 0x100});
    powermodels.push_back({"traceSelector_ROUND_SBOX_HW", 9});
    powermodels.push_back({"traceSelector_ROUND_MC", 0x100});
    powermodels.push_back({"traceSelector_ROUND_MC_HW", 9});
    powermodels.push_back({"traceSelector_ROUND1_SBOX", 0x100});
    powermodels.push_back({"traceSelector_ROUND1_SBOX_HW", 9});
    powermodels.push_back({"traceSelector_ROUND1_MC", 0x100});
    powermodels.push_back({"traceSelector_ROUND1_MC_HW", 9});
    powermodels.push_back({"traceSelector_ROUND1", 0x100});
    powermodels.push_back({"traceSelector_ROUND1_HW", 9});
    powermodels.push_back({"traceSelector_ROUND1_XOR_PLAIN", 0x100});
    powermodels.push_back({"traceSelector_ROUND1_XOR_PLAIN_HW", 9});
    ...
    auto cpuloader = [&listLock,&toNormalizeList,&filesCnt, &gpus, &activeCpuLoaderCnt, systemRam, minAllocSize](int transferWorkerNum)->void{
        ++activeCpuLoaderCnt;
        /*
        ...
        while (true) {
            ...
            if (toNormalizeList.size()) {
                ...
                CPUMem *curtrace = new CPUMem(new Traces(tpath.c_str(), minAllocSize),systemRam);
...
int r_main(int argc, const char * argv[]) {
    int ret = 0;
    if (argc < 3) {
        printf("Usage: %s <traces dir path> <outdir> {maxTraces} {minAllocSize}\n",argv[0]);
        return -1;
    }
    ...
    if (argc > 4) {
        minAllocSize = atol(argv[4]);
        printf("minAllocSize=%ld\n",minAllocSize);
    }

    
    ret = doSNR(indir, outdir, maxTraces, minAllocSize);
    printf("done!\n");
    return ret;
}
