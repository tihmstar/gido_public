...
//    ((ulong*)ptextAddkey)[0] = ((ulong*)&msm->Plaintext)[0] ^ ((ulong*)aeskey)[0];
//    ((ulong*)ptextAddkey)[1] = ((ulong*)&msm->Plaintext)[1] ^ ((ulong*)aeskey)[1];
...
__kernel void computeMeans(__global const struct Tracefile *tr, __global double *curgroupsMean, __global ulong *curgroupsMeanCnt){
    ...
    for (uint j=0; j < tracesInFile; j++,msm = (__global const struct MeasurementStructure *)(((uchar*)msm)+nextMsmOffset)){
